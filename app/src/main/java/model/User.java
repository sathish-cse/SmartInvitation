...
public class User {
    ...
    public String getReceiverMail(long createdAtCurrentUser, String currentUserEmail){
        String uniqueChatRef="";
        if(createdAtCurrentUser > getCreatedAt()){
            uniqueChatRef = cleanEmailAddress(currentUserEmail);
        }else {
            uniqueChatRef= cleanEmailAddress(getUserEmail());
        }
        return uniqueChatRef;
    }
